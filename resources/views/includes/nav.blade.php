	...
	<div class="bb-light col-12 back-body rel pt-em-1 pb-em-1 pl-5 pr-5 flex-between">
		<div class="col-6 flex-center-start">
			...
			<div>
				<div class="flex-center">
					...
					<a href="mailto:{{ $contacts->get('phoneMain')->value }}" class="ct">
						{{ $contacts->get('mailMain')->value }}
					</a>
				</div>
			</div>
		</div>
		...
		<div class="col-6 flex-center-end">
			<div class="flex-center-end">
				@auth
				<div class="mr-em-1">
					<img src="{{ asset('storage/avatars/' . $user->avatar) }}" alt="avatr" class="avatar" />
				</div>

				<a href="{{ url('/home') }}" class="rel mr-em-2 ct line-right">{{ $user->name }}</a>

				<a class="rel mr-em-2 ct" href="{{ route('logout') }}" onclick="event.preventDefault();
					document.getElementById('logout-form').submit();">
					<img src="{{ asset('img/icon/exit.png') }}" alt="Выход">
				</a>
		...
		<div class="rel col-5">
			...
			<div class="result__search abs col-12 shadow">
				<div class="result__wrapp col-12 b5 hide">
					<div class="container">
						<div class="noscroll">
							<div class="article" id="tbody"></div>
						</div>
					</div>
				</div>
			</div>
...
<div class="footer-bar fix bottom-left sd-12 flex-center-between back-body pr-5 pl-5">
	...
	<a href="{{ route('login') }}" class="p-em-1 @if(Request::is('home') || Request::is('home/*')) active @endif">
