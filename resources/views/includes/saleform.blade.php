...
<form action="{{ route('saleform.push') }}" class="sd-12 col-12 pr-5 pl-5 pb-5" method="POST">
    @csrf
    ...
    <div class="sd-12 col-12 flex-center-center">
        ...
        <div class="b5 bc sd-12 col-8 mt-em-1">
            <div class="form-label-group sd-12">
                <input type="url" id="url" name="url" class="form-control" placeholder="Введите ссылку" required>
