...
<body>
    <div class="modal__wrapp col-6 sd-12 shadow-xs back-body b8 hide">
        ...
        <h5 class="text-center">Поздравляем c покупкой!</h5>
        <div class="pl-em-3 pr-em-3 pb-em-3">
            <p class="cc">Уважаемый, {{ $contact['order_lname'] }} {{ $contact['order_fname'] }} {{ $contact['order_mname'] }}.</p>
            <p class="cc">Вас приветствует <span class="cm">Telezapchasti.ru</span></p>
            <p class="cc">Спасибо за вашу покупку в нашем интернет магазине.</p>
            <p class="cc">Номер вашего заказа <span class="bold ct">#{{ $contact['id'] }}</span></p>
            <p>Вы приобрели запчасти:</p>
            @foreach($contact['items'] as $item )
                <p class="ct">{{ $item }}</p>
            @endforeach
            <br>
            <p class="cc">Вами выбран способ оплаты Сбербанк Онлайн. Для оплаты Реквизиты__________</p>
            <p class="cc">Спасибо за вашу покупку. Ждем вас снова!</p>
