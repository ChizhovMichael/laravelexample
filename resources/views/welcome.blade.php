...
<head>
    ...
    <meta name="description" content="Телезапчасти.рф - продажа запчастей для телевизоров, запчасти для телевизоров, телезапчасти, телезапчасти.рф отзывы, запчасти для телевизоров спб, запчасти для телевизоров lg, запчасти для телевизоров samsung, запчасти для телевизоров самсунг, запчасти для телевизоров sony, бу запчасти телевизоров">
...
<body>
    ...
    <div class="pt-em-5 pb-em-5 pr-5 pl-5">
        <div class="p-em-2 back-body shadow col-7 sd-12 b8">
            ...
            <p class="cc">Наша компания занимаемся продажей запчастей для ЖК, LED, LCD, плазменным телевизорам. Огромная база запчастей для телевизоров. Постоянные обновления. Также занимаемся профессиональным ремонтом телевизоров как на дому так и в стационаре.</p>
