...
<head>
    ...
    <title>Интернет-магазин Telezapchasti.ru - Запчасти для телевизоров. О компании</title>
    <meta name="description" content="Telezapchasti.ru - продажа запчастей для телевизоров, запчасти для телевизоров, телезапчасти, запчасти для телевизоров спб, Telezapchasti.ru отзывы">
